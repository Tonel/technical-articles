...
-   [When to Use JSON in Your Database](https://dev.to/writech/when-to-use-json-data-in-a-relational-database-4i0b/)
...
-   [How To Avoid Bottlenecks in Node.js Applications](https://dev.to/writech/how-to-avoid-bottlenecks-in-nodejs-applications-1e73)    
...
## Octoparse
-   [Web Scraping Made Simple with Octoparse](https://dev.to/writech/web-scraping-made-simple-with-octoparse-2288)
-   [How To Scrape Data from Google Maps with Octoparse](https://dev.to/writech/how-to-scrape-data-from-google-maps-with-octoparse-3ib6)
-   [You Do Not Need to Code for Data Collection](https://dev.to/writech/you-do-not-need-to-code-for-data-collection-3n9k)
-   [How To Scrape Amazon Product Data Without Coding](https://dev.to/writech/how-to-scrape-amazon-product-data-without-coding-4ph1)   
